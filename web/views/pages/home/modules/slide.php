...
<div class="jd-slider">
        ...
        <ul class="slide-area">
            ...
            <div class="slideOpt opt1">
                ...
                <div class="slideText" style="top:20%; left:10%; width:40%;">
                    ...
                    <h2 class="text-uppercase" style="color:#777">Lorem ipsum</h2>

                    <h3 class="text-uppercase" style="color:#888">Lorem ipsum</h3>

                    <a href="#">

                        <button class="my-lg-3 btn text-uppercase templateColor border-0" >Ver Producto</button>
    ...
    <a class="prev d-none d-lg-block" href="#">
        <i class="fas fa-angle-left text-white px-2 py-5 rounded-right" style="background: rgba(0,0,0,.5);"></i>
        </a>
        <a class="next d-none d-lg-block" href="#">
        <i class="fas fa-angle-right text-white px-2 py-5 rounded-right" style="background: rgba(0,0,0,.5);"></i>
    </a>
