    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <!-- Brand Logo -->
        <a href="<?php echo $path ?> views/assets/js/index3.html" class="brand-link">
        ...
        <nav class="mt-2">
            ...
            <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="<?php echo $path ?> views/assets/js/starter.html" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Starter Page</p>
                    </a>
                </li>
            ...
            <li class="nav-item">
                <a href="<?php echo $path ?> views/assets/js/iframe.html" class="nav-link">
